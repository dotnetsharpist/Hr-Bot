...
uz_regions = [
    ["Хоразм", "Навоий", "Кораколпогистон"],
    ["Бухоро", "Самарканд", "Жиззах"],
    ["Сирдарё", "Тошкент", "Кашкадарё"],
    ["Сурхондарё", "Андижон", "Наманган"],
    ["Фаргона"]
]

ru_regions = [
    ["Хорезм", "Навои", "Каракалпакстан"],
    ["Бухара", "Самарканд", "Джизак"],
    ["Сырдарья", "Ташкент", "Кашкадарья"],
    ["Сурхандарья", "Андижан", "Наманган"],
    ["Фергана"]
]
